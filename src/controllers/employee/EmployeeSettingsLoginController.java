...
/**
 * Kontroler sceny używany z EmployeeSettingsLogin.fxml
 * Nowe okno do edycji loginu
 */
public class EmployeeSettingsLoginController {
    @FXML
    ...
    private void errorLogin() {
        ...
        dialogPane.getStylesheets().add(
                getClass().getClassLoader().getResource("/CSS/login.css").toExternalForm());
