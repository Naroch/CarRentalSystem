 ...
 *
 * Dany kontroler służy do obsługi szczegółów wypożyczeń klientów przez pracownika systemu
 */
public class EmployeeLoansDetailsController extends Component implements Initializable {
    ...
    String delivery_agency_name, delivery_agency_city, delivery_agency_road, delivery_agency_post_code,
            agency_delivery_email, delivery_agency_phone_number, delivery_agency_building_number;
    int summary_cost;

    /**
     * Inicjalizacja globalnych zmiennych dla generowania protokołów oddania
     */
    String loan_agency_name, loan_agency_city, loan_agency_road, loan_agency_post_code, loan_agency_email,
            loan_agency_phone_number, loan_agency_building_number;

    /**
     * Inicjalizacja globalnych zmiennych o informacjach o pracowniku który oddaje samochód klientowi
     * oraz o filii w której on pracuje
     * Zmienne są wykorzystywane przy generowaniu protokołów oddania
     */
    public static String handover_employee_name, handover_employee_surname, handover_employee_agency_name,
            handover_employee_agency_city, handover_employee_agency_road,
            handover_employee_agency_email, handover_employee_agency_post_code, handover_employee_agency_phone_number, loan_date_of_loan;
    public static int handover_employee_agency_building_number;

    /**
     * Inicjalizacja globalnych zmiennych o informacjach o pracowniku który przyjmuje samochód od klieta
     * oraz o filii w której on pracuje
     * Zmienne są wykorzystywane przy generowaniu protokołów zwrotu
     */
    public static String return_employee_name, return_employee_surname,return_employee_agency_name,
            return_employee_agency_city, return_employee_agency_road,
            return_employee_agency_email,return_employee_agency_post_code, return_employee_agency_phone_number, loan_date_of_delivery;
    public static int return_employee_agency_building_number;
    ...
    /**
     * Inicjalizacja komponentów z pliku EmployeeLoansDetails.fxml
     */
    @FXML
    ...
    void protokolyUszkodzeniaAuta(ActionEvent event) {
        EmployeeLoansController controller = new EmployeeLoansController();
        ...
        try {
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT DISTINCT l.id_loan, d.id_damage, p.photo " +
                    ...
                    "WHERE l.id_car = " + EmployeeLoansController.car_id);
            if (resultSet.next()) {
                Parent zmianaSceny = null;
                try {
                    zmianaSceny = FXMLLoader.load(getClass().getClassLoader().getResource("scenes/employee/EmployeeLoansDetailsDamagesDetails.fxml"));
                } catch (IOException e) {
                    e.printStackTrace();
                }
    ...
    /**
     * Dana metoda służy do pobrania informacji o pracowniku który oddaje samochód klientowi oraz
     * o filii w której on pracuje
     * @throws SQLException służy do obsługi blędów związanych z bazą danych MariaDB
     */
    protected void getFiliaEmployeeHandover() throws SQLException {
        EmployeeLoansController controller = new EmployeeLoansController();
        Connection connection = DataBase.connect();
        ResultSet resultSet = connection.createStatement().executeQuery("SELECT u.user_name, u.surname, " +
                "a.agency_name, a.city, a.road, " +
                "a.building_number, a.post_code, a.email, a.phone_number " +
                "FROM loans l " +
                "INNER JOIN users u on l.id_emphandover = u.id_users " +
                "INNER JOIN agency a on u.id_agency = a.id_agency " +
                "WHERE l.id_loan = " + EmployeeLoansController.loan_id);
        if(resultSet.next()) {
            handover_employee_name = resultSet.getString("user_name");
            handover_employee_surname = resultSet.getString("surname");
            handover_employee_agency_name = resultSet.getString("agency_name");
            handover_employee_agency_city = resultSet.getString("city");
            handover_employee_agency_road = resultSet.getString("road");
            handover_employee_agency_email = resultSet.getString("email");
            handover_employee_agency_building_number = resultSet.getInt("building_number");
            handover_employee_agency_post_code = resultSet.getString("post_code");
            handover_employee_agency_phone_number = resultSet.getString("phone_number");
        }
    }

    /**
     * Dana metoda służy do pobrania informacji o pracowniku który przyjmuje samochód od klienta oraz
     * o filii w której on pracuje
     * @throws SQLException służy do obsługi blędów związanych z bazą danych MariaDB
     */
    protected void getFiliaEmployeeReturn() throws SQLException {
        EmployeeLoansController controller = new EmployeeLoansController();
        Connection connection = DataBase.connect();
        ResultSet resultSet = connection.createStatement().executeQuery("SELECT l.id_emphandover, u.user_name, " +
                "u.surname, a.agency_name, a.city, a.road, " +
                "a.building_number, a.post_code, a.email, a.phone_number " +
                "FROM loans l " +
                "INNER JOIN users u on l.id_empreturn = u.id_users " +
                "INNER JOIN agency a on u.id_agency = a.id_agency " +
                "WHERE l.id_loan = " + EmployeeLoansController.loan_id);
        if(resultSet.next()) {
            return_employee_name = resultSet.getString("user_name");
            return_employee_surname = resultSet.getString("surname");
            return_employee_agency_name = resultSet.getString("agency_name");
            return_employee_agency_city = resultSet.getString("city");
            return_employee_agency_road = resultSet.getString("road");
            return_employee_agency_email = resultSet.getString("email");
            return_employee_agency_building_number = resultSet.getInt("building_number");
            return_employee_agency_post_code = resultSet.getString("post_code");
            return_employee_agency_phone_number = resultSet.getString("phone_number");
        }
    }
    ...
    void protokol_wydania() throws SQLException {
        getFiliaEmployeeHandover();
        EmployeeLoansController controller = new EmployeeLoansController();
        Connection con = DataBase.connect();
        ResultSet rs = con.createStatement().executeQuery("SELECT l.id_loan, a.agency_name, a.city, a.road, " +
                "a.building_number, a.post_code, a.email, a.phone_number \n" +
                "FROM loans l \n" +
        ...
        try {
            ...
            com.itextpdf.text.Font helvetica16 = new com.itextpdf.text.Font(helvetica,16, com.itextpdf.text.Font.BOLD);
            com.itextpdf.text.Font helvetica11b = new com.itextpdf.text.Font(helvetica, 11, com.itextpdf.text.Font.BOLD);
            com.itextpdf.text.Font helvetica11i = new com.itextpdf.text.Font(helvetica, 11, com.itextpdf.text.Font.ITALIC);
            com.itextpdf.text.Font helvetica13b = new com.itextpdf.text.Font(helvetica, 13, Font.ITALIC);
            ...
            addEmptyLine(preface, 1);
            preface.add(new Paragraph("Pracownik wydający samochód: ", helvetica11i));
            preface.add(new Paragraph("" +handover_employee_name+ " " +handover_employee_surname, helvetica11i));
            preface.add(new Paragraph("Filia: " +handover_employee_agency_name, helvetica11i));
            preface.add(new Paragraph( "Adres: " +handover_employee_agency_city+ ", " +handover_employee_agency_post_code+ ", " +handover_employee_agency_road+ " " +handover_employee_agency_building_number, helvetica11i));
            preface.add(new Paragraph("Numer telefonu: " +handover_employee_agency_phone_number, helvetica11i));
    ...
    void protokol_zwrotu() throws SQLException {
        getFiliaEmployeeReturn();
        EmployeeLoansController controller = new EmployeeLoansController();
        Connection con = DataBase.connect();
        ResultSet rs = con.createStatement().executeQuery("SELECT l.id_loan, a.agency_name, a.city, a.road, " +
                "a.building_number, a.post_code, a.email, a.phone_number, l.cost, l.date_of_delivery \n" +
                "FROM loans l \n" +
        ...
        try {
            ...
            addEmptyLine(preface, 1);
            preface.add(new Paragraph("Pracownik przyjmujący samochód: ", helvetica11i));
            preface.add(new Paragraph("" +return_employee_name+ " " +return_employee_surname, helvetica11i));
            preface.add(new Paragraph("Filia: " +return_employee_agency_name, helvetica11i));
            preface.add(new Paragraph( "Adres: " +return_employee_agency_city+ ", " +return_employee_agency_post_code+ ", " +return_employee_agency_road+ " " +return_employee_agency_building_number, helvetica11i));
            preface.add(new Paragraph("Numer telefonu: " +return_employee_agency_phone_number, helvetica11i));
            addEmptyLine(preface, 3);
            document.add(preface);
    ...
    public void slideshow() {
        ...
        int count_image = 1;
        try {
            ResultSet resultSet = connection.createStatement().executeQuery("SELECT DISTINCT c.id_car, l.id_loan, " +
                    "p.photo FROM loans l " +
    ...
    void changeStatus(ActionEvent event){
        ...
        try {
            ...
            preparedStatement.setInt(2, EmployeeLoansController.loan_id);
            ...
            if (String.valueOf(status2).equals("Zwrócony")) {
                ...
                preparedStatement2.setInt(2, EmployeeController.id_agency);
                ...
                try {
                    ResultSet rs = connection.createStatement().
                            executeQuery("select date_of_loan, cast(now() as date) as curr_date from loans where id_loan =  " + EmployeeLoansController.loan_id);
                ...
                preparedStatement3.setInt(1, EmployeeController.userId);
                preparedStatement3.setInt(2, EmployeeController.id_agency);
                preparedStatement3.setDate(3, data_zwrotu);
                preparedStatement3.setInt(4,newCost);
                preparedStatement3.setInt(5, EmployeeLoansController.loan_id);
            ...
            if (String.valueOf(status2).equals("Anulowany")) {
                ...
                preparedStatement6.setInt(2, EmployeeLoansController.loan_id);
            ...
            if (String.valueOf(status2).equals("Wypożyczony")) {
                ...
                System.out.println(EmployeeController.userId);
                System.out.println(EmployeeController.id_agency);
                ...
                preparedStatement7.setInt(1,EmployeeController.userId);
                preparedStatement7.setInt(2,EmployeeController.id_agency);
                preparedStatement7.setInt(3, EmployeeLoansController.loan_id);
    ...
    void AddPhotoDamage (ActionEvent event) {
        Parent zmianaSceny = null;
        try {
            zmianaSceny = FXMLLoader.load(getClass().getClassLoader().getResource("scenes/employee/EmployeeAddPhotoDamage.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        Scene menu = new Scene(zmianaSceny);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Connection con = DataBase.connect();
        try {
            ResultSet rs = con.createStatement().executeQuery("SELECT c.id_car, c.model, c.production_date, c.engine, " +
                    "c.fuel, c.registration_number, c.color, c.cost, " +
                    "u.user_name, u.surname, u.phone_number, u.email,l.status, l.id_car, l.date_of_loan, " +
                    "l.date_of_delivery, l.id_loan, d.description, d.damage_cost \n" +
                    "FROM cars c \n" +
