...
import controllers.client.ClientSettingsLoginController;
import controllers.client.ClientSettingsPasswordController;
...
/**
 * Kontroler sceny używany z EmployeeSettings.fxml
 * Zakładka Ustawień
 */
public class EmployeeSettingsController implements Initializable {
    ...
    private final int idUser = EmployeeController.userId;
    ...
    void updateHasloButton(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(
                getClass().getResource("scenes/client/ClientSettingsPassword.fxml")
        );
     ...
     */
    @FXML
    void EmployeeUzytkownicyButton(ActionEvent event) {
        Parent zmianaSceny = null;
        try {
