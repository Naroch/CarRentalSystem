...
import controllers.employee.EmployeeLoansDetailsController;
 ...
 */
public class AdminAddPhotoDamageController implements Initializable {
    /**
    ...
    void DescriptionButton(ActionEvent event) {
        ...
        car_damage_id = AdminLoansController.car_id;
        try {
    ...
    public void showPhotoDamage() throws SQLException, IOException {
        ...
        PreparedStatement statement = DataBase.connect().prepareStatement("SELECT d.id_damage, p.photo FROM damage d " +
                ...
                "WHERE d.id_car = " + AdminLoansController.car_id);
